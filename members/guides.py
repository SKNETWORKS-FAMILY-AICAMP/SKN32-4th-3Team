...
GUIDE_DATA = {
  ...
  'region-daegu': {
    "title": '대구광역시 분리배출 가이드',
    "icon": '#8B5E0B',
    "color": '#FFF8E1',
    "sections": [
      { "heading": '대구시 분리배출 특징', "items": ['일반주택은 문전수거, 공동주택은 단지 내 분리수거함 배출', '수거 요일·시간은 구·군 조례로 각각 상이', '부탄가스통은 구멍 뚫어 캔류로 배출'] },
      { "heading": '품목별 요령', "items": ['의류·폐식용유: 민간 수거함에 배출', '고철·비철금속: 이물질 제거 후 봉투 또는 끈으로 묶어 배출', '형광등·건전지: 주민센터 또는 아파트 전용수거함 배출', '대형폐기물: 인터넷 또는 구·군청 신고 후 스티커 부착 배출'] },
      { "heading": '음식물쓰레기', "items": ['RFID 종량기 또는 전용봉투 사용 (구·군별 상이)', '물기 최대한 제거 후 배출', '뼈·껍데기·씨앗류는 일반쓰레기'] },
      { "heading": '문의', "items": ['대구시 자원순환과: 053-803-4241', '달구벌콜센터: 120'] },
    ]
  },
  'region-daejeon': {
    "title": '대전광역시 분리배출 가이드',
    "icon": '#5B2D8B',
    "color": '#F3EEFA',
    "sections": [
      { "heading": '대전시 분리배출 특징', "items": ['전 지역 문전배출 원칙 (집·상가 앞)', '배출 요일·시간은 5개 자치구(동·중·서·유성·대덕)마다 상이', '도안 지역은 크린넷 투입구 사용'] },
      { "heading": '품목별 요령', "items": ['투명페트병: 별도 분리배출 (라벨 제거, 압축)', '스티로폼: 이물질·테이프 제거 후 배출', '비닐: 깨끗이 씻어 모아 배출', '폐형광등·건전지: 주민센터·아파트 전용수거함'] },
      { "heading": '음식물쓰레기', "items": ['전용봉투 사용 (자치구별 상이)', '서구: 저녁 6시 이후 대문 앞 배출 (일~목)', '크린넷 지역은 전용봉투로 투입구 사용'] },
      { "heading": '문의', "items": ['대전환경사업조합: 042-250-0600', '대전시청 환경녹지국'] },
    ]
  },
  'region-suwon': {
    "title": '수원시 분리배출 가이드',
    ...
    "color": '#E6F5EC',
    "sections": [
      { "heading": '수원시 분리배출 특징', "items": ['문전배출 기본 (집·점포 앞)', '4개 구(장안·권선·팔달·영통) 통합 기준 운영', '자원순환역·에코스테이션에서 상시 배출 가능'] },
      { "heading": '품목별 요령', "items": ['재활용품 7종: 병·캔, 투명페트병, 플라스틱, 비닐·스티로폼, 종이', '주간 배출은 무단투기 — 오후 8시~다음날 오전 5시 배출', '품목 섞어 배출 시 무단투기 해당', '자원순환역에 관리사 배치 (08~12시, 17~21시)'] },
      { "heading": '음식물쓰레기', "items": ['전용 종량제봉투 사용', '물기 제거 후 배출', '뼈·껍질류 일반쓰레기'] },
      { "heading": '문의', "items": ['수원시 자원순환과: 031-228-3263', '대형폐기물 신고: 031-5191-3249'] },
    ]
  },
  'region-ulsan': {
    "title": '울산광역시 분리배출 가이드',
    "icon": '#B85C00',
    "color": '#FFF3E0',
    "sections": [
      { "heading": '울산시 분리배출 특징', "items": ['구·군별 지정장소·지정용기에 배출', '무단투기 신고포상금제 운영', '남구: 그물망 무료 배부로 재활용품 분리 지원'] },
      { "heading": '품목별 요령', "items": ['투명페트병: 라벨 제거 후 압축, 별도 배출', '스티로폼: 이물질·테이프 제거 후 배출', '종량제봉투 점선 이상 담아 배출 금지', '비규격봉투·불법투기 쓰레기는 수거 거부'] },
      { "heading": '음식물쓰레기', "items": ['남구: 일몰 후~새벽 3시 대문 앞 배출', '동구: 저녁 8시~자정 종량제봉투에 묶어 배출', '토·일·공휴일 수거 없음'] },
      { "heading": '문의', "items": ['울산 남구 환경관리과: 052-226-5772', '울산 동구 자원순환과: 052-209-3612'] },
    ]
  },
}
